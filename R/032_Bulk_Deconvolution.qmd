...
bulkmtx <- read.csv2("../Data/031_Bulk_filteredCounts.csv", header = TRUE, row.names = 1)
...
```{r single cell}
# Modify your path
sce <- readRDS("../Data/Sce_SingleCell.rds")
```
...
```{r deconvolution}
# Marker list 
markers <- readxl::read_xlsx("../Markers/Marker_list_BU.xlsx")
