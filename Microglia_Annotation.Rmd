...
seurat_list <- lapply(list.files(file.path(data_path, "GSE98969_RAW"), full.name =TRUE), 
  function(file){
    file_ind <- which(list.files(file.path(data_path, "GSE98969_RAW"), full.name =TRUE) == file)
