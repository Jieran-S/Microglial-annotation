...
plotMarkerList <- function(countObject, feature_list, plot_type = c("Vln", "Rdg", "Htm"), 
                           group_var = c("seurat_clusters","label_calibrated","label_auto"), 
                           saving = FALSE){
...
(presentHeatmap <- plotMarkerList(countObject = sce_labelCali, feature_list = presentMarker, 
                                 plot_type = "Htm", group_var = "label_calibrated"))
presentVln <- VlnPlot(seurat_combi, features = presentMarker[-7], group.by = "label_calibrated", cols = pal_simpsons()(16),pt.size = 0, ncol = 6) 
presentRdg <- RidgePlot(seurat_combi, features = presentMarker[-7], group.by = "label_calibrated", cols =  pal_simpsons()(16), ncol = 6) 
```
